...
theory Big_Step_Ex7 imports Com_Ex7 begin
...
RepeatFalse: "\<lbrakk> (c, s\<^sub>1) \<Rightarrow> s\<^sub>2; \<not>bval b s\<^sub>2; (REPEAT c UNTIL b, s\<^sub>2) \<Rightarrow> s\<^sub>3 \<rbrakk>
